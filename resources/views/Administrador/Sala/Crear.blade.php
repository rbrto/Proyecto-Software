                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-xs-9">
                        ...
                        <ul class="nav nav-pills">
                            <li><a href="#tutorial">Tutorial Subir archivos Sala</a></li>
                        </ul>
            ...
            <div id="slider">
                <ul>
                    ...
                    <li>
                        ...
                        {!! Html::image('/img/tutorial/tutorialSala.png','tutorialSala') !!}
                        <p>Si el sistema no los encuentra parecido va a retornar a la vista principal con un mensaje de error</p>
                    </li>
                    <li>
                        <p> El tipo de sala debe de existir en el sistema de lo contrario pasara a la fila siguiente del CSV </p>
                    </li>
                    <li>
                        <p> Basta que una Sala no exista para que el sistema guarde el nombre, los demas que ya existan los pasara por alto </p>
                    </li>
                </ul>
            </div>
        </div>
