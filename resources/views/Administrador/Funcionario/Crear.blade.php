            ...
            <div id="slider">
                <ul>
                    ...
                    <li>
                        ...
                        {!! Html::image('/img/tutorial/tutorialFuncionario.png','tutorialFuncionario') !!}
                    ...
                    <li>
                        <p> Basta que un Funcionario no exista para que el sistema lo guarde, los demas que ya existan los pasara por alto </p>
                    </li>

                    <li>
                        <p> El nombre del Departamento debe de existir, de lo contrario pasara a la siguiente fila de CSV  </p>
                    </li>
                </ul>
            </div>
        </div>
